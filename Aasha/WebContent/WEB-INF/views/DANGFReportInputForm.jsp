...
<script language="javascript">
	function submitMLIForm() {
		document.getElementById('A').action = "/Aasha/DANGFReportDetailList.html";
		...
		<div class="container-fluid">
			<div class="frm-section">
				...
				<!-- <button style="border:none !important;" > -->
		    		...
		    		<!-- </button> -->
						...
						<thead>
							<tr>
									...
									<th>CGST Amount</th>
									<th>SGST Amount</th>
									<th>Guarantee Start Date / Realization Date</th>
						  ...
						  <c:forEach items="${rows1}" var="item" varStatus="status">
									<tr>
									  ...
									  <!--  // <a href="a.html?fruit=apple" id="a">Hello</a> -->
										<td align="center"> <a href="/Aasha/DANIDwise.html?danId=${item[0]}">${item[0]} </a></td>
					...
					<center>
						<div class="d-inlineblock mt-35">
										<form:form action="/Aasha/DANGFbackButton.html">
		...
		<div class="container-fluid">
			<div class="frm-section">
				...
				<!-- <button style="border:none !important;" > -->
		    		...
		    		<!-- </button> -->
						...
						<tbody>
						  ...
						  <c:forEach items="${rows3}" var="item" varStatus="status">
									<tr>
									    <td><%=counter + 1%></td>
									    <td align="center"> <a href="/Aasha/CGPNDetails.html?cgpnNo=${item[5]}">${item[0]} </a></td>  
										<td align="center">${item[1]}</td>
										<td align="center">${item[2]}</td>
										<td align="center">${item[3]}</td>
										<td align="center">${item[4]}</td>
					...
					<div align="center">
						<!-- <div class="d-inlineblock mt-35"> -->
										<form:form action="/Aasha/DANGFbackButton1.html">
										<input type="submit" value="Back" class="btn btn-reset"
											class="btn btn-reset" />
											</form:form>
									 </div>
 ...
 -->
               ...
               <table cellpadding=3
						...
						<tr>
	                     ...
	                     <form:form action="/Aasha/DANGFbackButton2.html">
										<input type="submit" value="Back" class="btn btn-reset"
											class="btn btn-reset" />
											</form:form>
