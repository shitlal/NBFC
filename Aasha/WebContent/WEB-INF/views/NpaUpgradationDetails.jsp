...
<body onload="clearField()">
   ...
   <li class="breadcrumb-item"><a href="/Aasha/NPAUpgradation.html">NPA Upgradation</a></li>  
					...
					<div class="col-md-12">
						...
						<div id="successMsgId">
							<h5 class="notification-message">
								...
								<form:form method="POST" id="A" action="/Aasha/SaveNpaUpgradation.html"
	...
	function saveNpaUpgradation() {
		...
		if(document.getElementById('npaDt').value!=null && document.getElementById('npaUpgradationDt').value!="") {
			...
			if (Date1 >= Date) {	
				...
				var npaDt=
					document.getElementById('A').action = "/Aasha/SaveNpaUpgradation.html";
					document.getElementById('A').submit();
			}
		}
