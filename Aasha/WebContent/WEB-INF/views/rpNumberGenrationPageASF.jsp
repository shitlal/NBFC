...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb cus-breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/Aasha/danAllocationASF.html">Confirm Guarantee Fee Allocation</a></li>  
...
<script type="text/javascript">
	...
	function submitToProcess() {
		//alert('Back');
		document.getElementById('A').action = "/Aasha/rpNumberConfirmationASF.html";
		document.getElementById('A').submit();
	}
