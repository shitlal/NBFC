...
/* 			
	...
	if(chkflag==5){	
		document.getElementById('editClaimDataReturnByNBFCMakerFormId').action = "/Aasha/editClaimDataReturnByNBFCMaker.html";
									...
									<div class="col-md-12 prl-10">
										...
										<label>Amount Claimed in the Demand
											Notice/Suit(in&#8377;): <span style="color: red">*</span>
												...
												path="claimAmt" id="claimAmt" value="${formData1.claimAmtInDemand}"
											...
											principal/interest over dues?<span style="color: red">*</span>
												...
												<c:when test="${formData1.subsidyAdjust=='Y'}">
													<form:radiobutton path="subsidyAdjust" value="Y" id="subsidyAdjust"
														checked="checked" onclick="calTotOutstandingAsOnDateOfLodgementOfClaim(this.value)"/>Yes 
												 			<form:radiobutton path="subsidyAdjust" value="N" id="subsidyAdjust" onclick="calTotOutstandingAsOnDateOfLodgementOfClaim(this.value)"/>No
												 		</c:when>
												<c:when test="${formData1.subsidyAdjust=='N'}">
													<form:radiobutton path="subsidyAdjust" value="Y" id="subsidyAdjust" onclick="calTotOutstandingAsOnDateOfLodgementOfClaim(this.value)"/>Yes 
												 		<form:radiobutton path="subsidyAdjust" value="N" id="subsidyAdjust"
														checked="checked" onclick="calTotOutstandingAsOnDateOfLodgementOfClaim(this.value)"/>No
												 	</c:when>
												<c:otherwise>
													<form:radiobutton path="subsidyAdjust" value="Y" id="subsidyAdjust" onclick="calTotOutstandingAsOnDateOfLodgementOfClaim(this.value)"/>Yes 
												 		<form:radiobutton path="subsidyAdjust" value="N" id="subsidyAdjust" onclick="calTotOutstandingAsOnDateOfLodgementOfClaim(this.value)"/>No
