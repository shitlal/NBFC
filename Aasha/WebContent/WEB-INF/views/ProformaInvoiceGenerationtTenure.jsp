		...
		<div class="container-fluid">
			<div>	
				<div class="tbl-details">
					<div class="col-md-12">
						<h2 align="center" class="heading">Generate Proforma-Invoice For Tenure</h2>
		...
		<table id="myTable" class="table table-bordered table-hover cus-table mt-10 mb-10 danRpDataTable">
			...
			<% int counter=0;%>
				...
				<tr>
				    ...
				    <td align="center"><a href="/Aasha/callJasperReportOfProformaTenure.html?danId=${dataList.danId}">Generate ProformaInvoice</a></td>											
				</tr>
				<%  counter+=1;%>
			</c:forEach>
		</table>	
