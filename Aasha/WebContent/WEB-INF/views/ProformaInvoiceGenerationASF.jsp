		...
		<div class="container-fluid">
			<div>
				<div class="tbl-details">
					<div class="col-md-12">
						<h2 align="center" class="heading">Generate Proforma-Invoice
							For ASF</h2>
						...
						<form:form method="POST" id="A" class="form-horizontal">
							...
							<c:if test="${!empty dataList}">
								<table id="myTable"
									class="table table-bordered table-hover cus-table mt-10 mb-10 danRpDataTable">
									<thead>
										<tr>
											<th>SR.NO.</th>
											<th>MLI NAME</th>
									...
									<c:forEach items="${dataList}" var="dataList">
										<tr>
											...
											<td align="center"><a
												href="/Aasha/callJasperReportOfProformaASF.html?danId=${dataList.danId}&year=${dataList.asfYear}">Generate
													ProformaInvoice</a></td>
										</tr>
										<%
											counter += 1;
										%>
