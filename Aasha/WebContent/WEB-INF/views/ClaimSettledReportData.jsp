	...
	<div class="main-section">
		...
		<ol class="breadcrumb cus-breadcrumb">
			<li class="breadcrumb-item"><a
				href="/Aasha/ClaimSettledReport.html">Claim Settled Report</a></li>
			<li class="breadcrumb-item active" aria-current="page">Claim
				Settled Report Data</li>
		</ol>
		</nav>
		<div class="container-fluid">
			<div>
				<div class="frm-section">
					<div class="col-md-12">
						<h2 align="center" class="heading">Claim Settled Report</h2>
		    		...
		    		<button style="border:none !important;"> -->
						<!-- 	<a href="ClaimSettledReportDownload.html"> <img
								src="images/excel.png" alt="" data-toggle="tooltip"
								title="Export To Excel">
							</a>-->
							<a href="ClaimSettledReportDownloadAll.html"> <img
								src="images/excel.png" alt="" data-toggle="tooltip"
								title="Export To Excel">
							</a>
						<!-- 	</button>-->
						...
						<form:form method="POST" action="" id="A" class="form-horizontal">
							...
							<table id="myTable"
								...
								<thead>
									<tr>
										<c:forEach items="${ClaimSettledDataReport[0]}" var="column">
											<th class="tableHeader1"><c:out value="${column.key}" /></th>
										</c:forEach>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${ClaimSettledDataReport}" var="columns">
										<tr>
