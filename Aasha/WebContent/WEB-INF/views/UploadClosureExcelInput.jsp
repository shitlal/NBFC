...
<html>
<head>
<title>RF UTR Excel Upload</title>
		...
		<form:form method="POST" enctype="multipart/form-data" id="A" class="form-horizontal">
		  <h5 class="notification-message"><strong>${message}</strong></h5>
			...
			<div class="col-md-2 col-sm-4 col-xs-12">
			  ...
			  <a href="Download/CLOSURE EXCEL TEMPLATE.xls" >Click here to download Excel Template File</a>
...
function validate_fileupload(ID){
    ...
    if(inp.files.length === 0){
      ...
      return false;
    	...
    	document.getElementById('A').action = "/Aasha/UploadClosureProcess.html";
