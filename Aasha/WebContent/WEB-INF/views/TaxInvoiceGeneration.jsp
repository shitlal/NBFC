		...
		<table id="myTable" class="table table-bordered table-hover cus-table mt-10 mb-10 danRpDataTable">
			...
			<% int counter=0;%>
				...
				<tr>
					...
					<td align="center"><c:out value="${dataList.danType}" /></td>
					<td align="center"><c:out value="${dataList.payId}" /></td>
					<td align="center"><c:out value="${dataList.taxInvId}" /></td>
				<%-- <input type="hidden" value="${dataList.userId}" /> --%>
				  <td align="center"><a href="/Aasha/downloadPDfForSuccessGeneratedIRNNBFC.html?portfolioName=${dataList.portfolioName}&danType=${dataList.danType}&payId=${dataList.payId}&taxInvId=${dataList.taxInvId}">Generate TaxInvoice</a></td>											
				<%--     <td align="center"><a href="/Aasha/callJasperReportOfTax.html?portfolioName=${dataList.portfolioName}&userId=${dataList.userId}">Generate TaxInvoice</a></td>											 --%>
				</tr>
				<%  counter+=1;%>
			</c:forEach>
		</table>	
