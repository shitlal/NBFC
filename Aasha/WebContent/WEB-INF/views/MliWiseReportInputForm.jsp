	...
	<head>
		...
		<script language="javascript">
			function getMLIWiseReportForm() {
				document.getElementById('A').action = "/Aasha/MliWiseReportDetailList.html";
					...
					<div class="col-md-12">
					 <div style="text-align: left;">
			    		<a href="MliWiseReportDetailDownload.html">
							...
							<tfoot>
						    	<tr>
					               <th colspan="3" style="background:rgba(176, 174, 178, 1); text-align:center; font-weight:700; font-size:16px;"> Total</th>
							...
							<div class="d-inlineblock mt-35">
											<form:form action="/Aasha/MLIWisebackButton.html">
