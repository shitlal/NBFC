	...
	<!--<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label>
		...
		<div class="login-form">
			...
			<div class="group">
					...
					<form:input path="newPassword" value="" placeholder="******"  class="input" maxlength="8" type="password"/>
					<form:errors path="newPassword" Class="error"/>										
			</div>
			
			<div class="group">
					<label for="new password" class="label">Confirm Password</label>					
					<form:input path="confirm_password" value="" placeholder="******" class="input" maxlength="8" type="password"/>
