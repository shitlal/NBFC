...
<div class="main-section">
   ...
   <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/Aasha/AppClosureRequestApproval.html">Request for Closure Approval/Return</a></li>  
  </ol> 
</nav>
			...
			<thead>
					...
					<c:forEach items="${dataList}" var="dataList">
						...
						<tr>
							...
							<td><a href="/Aasha/AppClosureRequestUpdate.html?Cgpan=${dataList.CGPAN}"><c:out value="${dataList.CGPAN}" /></a></td>
...
function AppClosureApprove() {
		...
		if ($selectedCBs.length === 0) {
			...
			document.getElementById('A').action = "/Aasha/SaveAppClosureApprove.html";
	...
	function AppClosureReject() {
		...
		if ($selectedCBs.length === 0) {
			...
			//alert("hellow "+hiddenValue); 
			document.getElementById('A').action = "/Aasha/SaveAppClosureReject.html";
			document.getElementById('A').submit();
			}else{
