...
<!-- <div class="row"> -->
  ...
  <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/Aasha/betweenTwoDateAppropriation.html">Appropriation 2</a></li>  
    ...
    if ($selectedCBs.length === 0) {
    	...
    	//	 approveCount=$selectedCBs.length-1;
    	 ...
    	 //   }
    	    ...
    	    if(chkflag==5){
    		document.getElementById('A').action = "/Aasha/updateAppropriateData.html?rpno=" +"<c:out value="${paymentId}"/>";
