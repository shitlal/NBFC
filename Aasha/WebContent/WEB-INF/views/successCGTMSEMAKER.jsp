...
<div class="main-section" >
	...
	<div id="wel-sec">
 	...
 	<div class="col-md-4">
 		...
 		<div class="d-box bg-promogranted" id="btn-mlibatches" onClick="window.open('cgtmseMakerForBatchApprovalUploadedBatchFileRM.html?subPortfolioDtlNumber=${subPortfolioDtlNoKey}&statusNCA=${statusKey}&totalNoOfUploadBatchFile=${totalNoOfUploadedFileKey}', '_blank')"> 
 			<h3>MLI Forwarded and Rejected batches</h3>
 			<p><span>${countTotalNoOfUploadedFileKey}</span>  </p>
 			<i class="fa fa-file-text" aria-hidden="true"></i>
 		</div>
