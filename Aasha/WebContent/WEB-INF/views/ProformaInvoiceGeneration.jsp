		...
		<table id="myTable" class="table table-bordered table-hover cus-table mt-10 mb-10 danRpDataTable">
			...
			<% int counter=0;%>
				...
				<tr>
				    ...
				    <td align="center"><a href="/Aasha/callJasperReportOfProforma.html?portfolioName=${dataList.portfolioName}&userId=${dataList.userId}">Generate ProformaInvoice</a></td>											
				</tr>
				<%  counter+=1;%>
			</c:forEach>
		</table>	
