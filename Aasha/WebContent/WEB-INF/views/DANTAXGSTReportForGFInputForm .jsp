...
<script language="javascript">
	function submitMLIForm() {
		document.getElementById('A').action = "/Aasha/DANTAXGSTReportForGFList.html";
		...
		<div class="container-fluid">
			<div>
				...
				<div class="frm-section">
					...
					<div class="col-md-12">
						 <h2 align="center" class="heading">DAN TAX(GST) Report For GF</h2>
		...
		<div class="container-fluid">
			<div class="frm-section">
				...
				<!-- <button style="border:none !important;" > -->
		    		<a href="DANTAXGSTReportForGFListDownload.html">
		    		...
		    		<!-- </button> -->
						...
						<thead>
							<tr>
									...
									<th>PORTFOLIO NO</th>
									<th>TAX INV ID</th>
									<th>DCI AMOUNT RAISED DANAMT</th>
                                    <th>BASEAMT</th>
									<th>IGST AMT </th>
									<th>IGST RATE</th>
									<th>CGST AMT </th>
									...
									<th>SGST AMT </th>
									<th>SGST RATE </th>
									<th>DCI APPROPRIATION FLAG </th>
									<th>DCI APPROPRIATION DT</th>
									<th>DCI GUARANTEE START DT </th>
									<th>MEM STATE NAME </th>
							  </tr>
						</thead>
						<tbody>
						  ...
						  <c:forEach items="${rows1}" var="item" varStatus="status">
									<tr>
										...
										<td align="center"><a href="/Aasha/callJasperReportOfTax.html?portfolioName=${item[5]}&userId=${userId}">${item[5]}</a></td>	  		
					...
					<center>
						<div class="d-inlineblock mt-35">
										<form:form action="/Aasha/DANGstGfbackButton.html">
