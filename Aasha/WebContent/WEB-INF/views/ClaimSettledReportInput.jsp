...
<script language="javascript">
	function submitClaimReportForm() {
		...
		document.getElementById('A').action = "/Aasha/ClaimSettledReportData.html";
...
<body>
 ...
 <nav aria-label="breadcrumb">
   <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/Aasha/ClaimSettledReport.html">Claim Settled Report</a></li>  
  </ol> 
</nav>
