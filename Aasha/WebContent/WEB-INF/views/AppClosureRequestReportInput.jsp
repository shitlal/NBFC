...
<title>Closure Request Report</title>
...
<script language="javascript">
	function submitClosureReportForm() {
		debugger;
		document.getElementById('A').action = "/Aasha/ClosureReportData.html";
...
<body>
   ...
   <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/Aasha/AppClosureRequestReport.html">Closure Request Report</a></li>  
  </ol> 
</nav>
