...
<html>
	...
	<body >
		...
		<ol class="breadcrumb cus-breadcrumb">
			...
			<a href="/Aasha/claimLoadgementApprovalCGTMSE.html?MLIName=${MLIID}">Claim Lodgement
					Approval</a></li>
								...
								<div class="col-md-3 col-sm-4 col-xs-12 mar-top21">
									<div class="form-group">
										<div class="col-md-12 prl-10">
											...
											<label class="d-block"> <form:input path="claimAmt" id="claimAmt" value="${formData.claimAmtInDemand}" size="20"  class="form-control cus-control" readonly="true" /> </label>
										</div>
									</div>
								</div>
