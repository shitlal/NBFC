...
<script language="javascript">
	function submitNPAUpgradationReportForm() {
		document.getElementById('A').action = "/Aasha/NPAUpgradationReportData.html";
...
<body>
 ...
 <nav aria-label="breadcrumb">
   <ol class="breadcrumb cus-breadcrumb">
    <li class="breadcrumb-item"><a href="/Aasha/NPAUpgradationReportInput.html">NPA Upgradation Report</a></li>  
  </ol> 
</nav>
