...
<script language="javascript">
	function submitTenureModificationReportForm() {
		document.getElementById('A').action = "/Aasha/TenureModRepData.html";
								...
								<div class="form-group">
									<div class="d-inlineblock mt-35">
										<input type="submit" value="Submit" class="btn btn-reset" 										
											class="btn btn-reset" 	onclick="submitTenureModificationReportForm()" />
									</div>
								</div>
							</div>
							<div></div>
