...
<html>
	<head>
		...
		<script language="javascript">
			function getASFSummaryReportForm() {
				document.getElementById('A').action = "/Aasha/AsfReportDetailList.html";
									...
									<div class="form-group">
										...
										<div class="d-inlineblock mt-35">
											<input type="submit" value="Submit" class="btn btn-reset"
												class="btn btn-reset" onclick="getASFSummaryReportForm()" />
										</div>
									</div>
								</div>
								<div></div>
					...
					<div class="col-md-12">
					 <div style="text-align: left;">
			    		<a href="ASFReportDetailDownload.html">
							...
							<div class="d-inlineblock mt-35">
								<form:form action="/Aasha/ASFbackButton.html">
