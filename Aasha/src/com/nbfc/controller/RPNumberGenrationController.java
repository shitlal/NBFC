...
@Controller
public class RPNumberGenrationController {
	...
	@RequestMapping(value = "rpNumberGenration", method = RequestMethod.GET)
	public ModelAndView submitForConfirm(
		...
		if (!allocationList.isEmpty()) {
			if(userId!=null){
				danAllocation = danAllocationService.getRpNumberData(allocationList,userId);
			}
...
//				userActivityService.getActivity("NBFCMAKER", "User_Activity"));
		...
		return new ModelAndView("rpNumberGenrationPage", modelAct);
	}
	...
	@RequestMapping(value = "genrateRPNumberVirtualAC", method = RequestMethod.GET)
	public ModelAndView submitRPForConfirm(
...
//				userActivityService.getActivity("NBFCMAKER", "User_Activity"));
	...
	@RequestMapping(value = "editRPNUmber", method = RequestMethod.GET)
	public ModelAndView editRPNumber(
...
//				userActivityService.getActivity("NBFCMAKER", "User_Activity"));
	...
	@RequestMapping(value = "paymentInscate", method = RequestMethod.GET)
	public ModelAndView paymentInscate(
			@ModelAttribute("command") DANAllocationBean loginBean,
			BindingResult result, Model model, HttpSession session) {
		log.info("adminHome***************************************************************************************************************"
				+ session.getAttribute("userId"));
...
//				userActivityService.getActivity("NBFCMAKER", "User_Activity"));
	...
	@RequestMapping(value = "rpNumberConfirmation", method = RequestMethod.GET)
	public ModelAndView rpNumberConfirmation(
...
//				userActivityService.getActivity("NBFCMAKER", "User_Activity"));
		modelAct.put("homePage", "nbfcMakerHome");
		return new ModelAndView("rpNumberConfirmationPage", modelAct);
	}

	@RequestMapping(value = "rpNumberConfirmationScreen", method = RequestMethod.GET)
	public ModelAndView rpNumberConfirmationScreen(
			@ModelAttribute("command") DANAllocationBean danAllocationBean,
			BindingResult result, Model model, HttpSession session)
			throws ParseException {
		log.info("adminHome***************************************************************************************************************"
