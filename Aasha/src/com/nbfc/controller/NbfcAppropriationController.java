...
@Controller
public class NbfcAppropriationController {
	@Autowired
	com.nbfc.service.NbfcAppropriationService nbfcAppropriationService;
	static Logger log = Logger.getLogger(NbfcAppropriationController.class
			.getName());
	@Autowired
	...
	@RequestMapping(value = "/getAppropriationData", method = RequestMethod.GET)
	public ModelAndView getDataDateWise(@ModelAttribute("command")NbfcAppropriationBean bean,BindingResult result,Model model1,HttpServletRequest request,HttpSession session) throws ParseException {
...
//				"CGTMSEMAKER", "User_Activity"));
		return new ModelAndView("dateAppropriation",modelAct);

	}
	@RequestMapping(value = "/getAppropriationDataBetweenDates", method = RequestMethod.GET)
	public ModelAndView getAppropriationDataBetweenDates(@ModelAttribute("command")NbfcAppropriationBean bean,BindingResult result) {
		log.info("Enter in getDataDateWise() method in NbfcAppropriationController class");
		//added by say 6 feb-----------------------
		Map<String, Object> modelAct = new HashMap<String, Object>();
		modelAct.put("adminlist",
...
//		modelAct.put("actList", userActivityService.getActivity(
//				"CGTMSEMAKER", "User_Activity"));
		return new ModelAndView("dateAppropriationBetweenDates",modelAct);

	}
	@RequestMapping(value = "/dateWiseGfBatchApplicaiton", method = RequestMethod.POST)
	public ModelAndView getAppropriationData(@ModelAttribute("command")@Valid NbfcAppropriationBean bean,BindingResult result,Model model1,HttpServletRequest request,HttpSession session) throws ParseException {
		...
		if(result.hasErrors()){
		 ...
		 list = nbfcAppropriationService.getDataForAppropriation(date1);
		}
		//if (mliId != null) {
		...
		return new ModelAndView("dateWiseGfBatchApplicaiton", model);

	}
	
	@RequestMapping(value = "/betweenTwoDateAppropriation", method = {RequestMethod.GET,RequestMethod.POST})
	public ModelAndView getDataBetweenTwoDateAppropriation(@ModelAttribute("command") NbfcAppropriationBean bean,BindingResult result,Model model1,HttpServletRequest request,HttpSession session) throws ParseException {
		log.info("Enter in getAppropriationData() method in NbfcAppropriationController class");
		Map<String, Object> model = new HashMap<String, Object>();
	...
	//end---------------------------------------------------------------------------------------	
			...
			list = nbfcAppropriationService.getDataBetweenTwoDateForAppropriation(fromDateHidden1,toDateHidden1);
		}
		//if (mliId != null) {
...
//				"CGTMSEMAKER", "User_Activity"));
		...
		return new ModelAndView("nbfcAppropriationDataBetweenDates", model);

	}
	
	
	@RequestMapping(value = "/saveAppropriationData", method = RequestMethod.POST)
	public ModelAndView saveAppropriationData(@ModelAttribute("command")NbfcAppropriationBean contactForm,BindingResult result,Model model1,HttpServletRequest request,HttpSession session) {
		log.info("Enter in getAppropriationData() method in NbfcAppropriationController class");
		Map<String, Object> model = new HashMap<String, Object>();
...
//					"CGTMSEMAKER", "User_Activity"));
	...
	@RequestMapping(value = "/getAppropriatePayment", method = RequestMethod.GET)
	public ModelAndView getAppropriatePayment(@ModelAttribute("command")DemandAdvice demandAdvice,String paymentId) {
		...
		List list = nbfcAppropriationService.getAppropriatePaymentDetails(paymentId);
...
//				"CGTMSEMAKER", "User_Activity"));
		...
		return new ModelAndView("appropriatePayment", model);

	}
	
	@RequestMapping(value = "/updateAppropriateData", method = RequestMethod.POST)
	public ModelAndView saveAppropriatePayment(@ModelAttribute("command")DemandAdvice demandAdvice,String rpno,HttpSession Session) {
		log.info("Enter in getAppropriatePayment() method in NbfcAppropriationController class");
	//	HttpSession Session=null;
		...
		List list = nbfcAppropriationService.getAppropriatePaymentDetails(rpno);
...
//				"CGTMSEMAKER", "User_Activity"));
		...
		return new ModelAndView("appropriatedAmountSucces", model);
