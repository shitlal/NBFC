...
//				userActivityService.getActivity("CGTMSEMAKER", "User_Activity"));
	...
	private AudMLiDetails prepareModelForMLIAUD(MLIEditDetails mliRegNean,String userId) throws ParseException {
		...
		if(mliRegNean.getPhone_code()!=null) {
			mliReg.setPhone_code(mliRegNean.getPhone_code());
		}else {
			mliReg.setPhone_code("");
		}
		
		if(mliRegNean.getLandlineNumber()!=null) {
			mliReg.setLandlineNumber(mliRegNean.getLandlineNumber());
		}else {
	...
	private MLIEditDetails prepareModelForMLIEdit(MLIDEtailsBean mliRegNean, MLIRegistration mliRegistration,String userId) throws ParseException {
		...
		///System.out.println("mliRegistration.getPhone_code(222)===="+mliRegNean.getPhone_code());
		///System.out.println("mliRegistration.getPhone_code()2222===="+mliRegNean.getLandlineNumber());
	
		///System.out.println("mliRegistration.getPhone_code()===="+mliRegistration.getPhone_code());
		//System.out.println("mliRegistration.getPhone_code()===="+mliRegistration.getLandlineNumber());
			
		if(mliRegistration.getPhone_code()!=null) {
			mliReg.setPhone_code(mliRegistration.getPhone_code());
		}else {
			mliReg.setPhone_code("");
		}
		if(mliRegistration.getLandlineNumber()!=null) {  
			mliReg.setLandlineNumber(mliRegistration.getLandlineNumber());
		}else {
			mliReg.setLandlineNumber("");
		}
		...
		mliReg.setState(mliRegistration.getState());
