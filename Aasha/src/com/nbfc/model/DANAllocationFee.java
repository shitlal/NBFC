...
public class DANAllocationFee {
	...
	private double DCI_AMOUNT_RAISED;
	...
	private Double CLAIM_RISK_RATE;
	...
	public double getDCI_AMOUNT_RAISED() {
		return DCI_AMOUNT_RAISED;
	}
	public void setDCI_AMOUNT_RAISED(double dCI_AMOUNT_RAISED) {
	...
	public Double getCLAIM_RISK_RATE() {
		return CLAIM_RISK_RATE;
	}
	public void setCLAIM_RISK_RATE(Double cLAIM_RISK_RATE) {
