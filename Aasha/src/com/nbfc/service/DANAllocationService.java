...
public interface DANAllocationService {
	...
	public List<DANAllocationFee> getCGAmoutDetailsList(List<String> DanId,String status);
	...
	public List<DANAllocation> danListDANAllocation(List<String> danID,String status);
	
	public List<DANAllocationFee> getApyIDAmoutDetailsList(List<String> DanId,String status);
	...
	public List<DanCorrespondingDataListBeanCheckerBean> getDisburseNonDisburseData(String fileName,
			String disbursedStatus);
